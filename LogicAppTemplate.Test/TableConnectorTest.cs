...
namespace LogicAppTemplate.Test
{
    ...
    public class TableConnectorTest
    {
        ...
        public void TableConnectionTest()
        {
            ...
            Assert.AreEqual("[listKeys(resourceId(parameters('azuretables_resourceGroupName'),'Microsoft.Storage/storageAccounts', parameters('azuretables_storageaccount')), '2018-02-01').keys[0].value]", connection["properties"]["parameterValues"].Value<string>("sharedkey"));
